...
def create_admin_dashboard(app: gr.Blocks, user_state: gr.State):
    with gr.Group(visible=False) as dashboard:
        ...
        with gr.Tabs():
            ...
            # ─── Tab 1: Analysis (Admin also runs scans) ──────────────────────
            ...
            # ─── Tab 2: Environments ──────────────────────────────────────────
            with gr.TabItem("\U0001f30d Environments"):
                with gr.Group(elem_classes=["glass-card"]):
                    with gr.Row():
                        ...
                        env_refresh = gr.Button("\U0001f504", elem_classes=["glass-btn"], scale=0, min_width=40)
            ...
            # ─── Tab 3: Reports ───────────────────────────────────────────────
            with gr.TabItem("\U0001f4d1 Reports"):
                with gr.Group(elem_classes=["glass-card"]):
                    with gr.Row():
                        ...
                        rep_refresh = gr.Button("\U0001f504", elem_classes=["glass-btn"], scale=0, min_width=40)
            ...
            # ─── Tab 4: IaC Scan ─────────────────────────────────────────────
            with gr.TabItem("\U0001f3d7\ufe0f IaC Scan"):
                with gr.Group(elem_classes=["glass-card"]):
            ...
            # ─── Tab 5: CI/CD Gate ────────────────────────────────────────────
            with gr.TabItem("\U0001f6a6 CI/CD Gate"):
                with gr.Group(elem_classes=["glass-card"]):
                    ...
                    with gr.Row():
                        ...
                        cicd_refresh = gr.Button("\U0001f504", elem_classes=["glass-btn"], scale=0, min_width=40)
            ...
            # ─── Tab 6: Audit Log ─────────────────────────────────────────────
            with gr.TabItem("\U0001f4cb Audit Log"):
                with gr.Group(elem_classes=["glass-card"]):
            ...
            # ─── Tab 8: Plugin Management ─────────────────────────────────────
            with gr.TabItem("\U0001f50c Plugins"):
                with gr.Group(elem_classes=["glass-card"]):
            ...
            # ─── Tab 9: User Approvals (Admin-only) ───────────────────────────
            ...
            with gr.TabItem("\U0001f465 User Management"):
                with gr.Group(elem_classes=["glass-card"]):
                    ...
                    gr.HTML("<div class='sidebar-title'>\U0001f510 Project Access Assignment</div>")
                    gr.HTML("""
            ...
            # ─── Tab 11: Profile ──────────────────────────────────────────────
            with gr.TabItem("\U0001f464 Profile"):
                with gr.Group(elem_classes=["glass-card"]):
        ...
        with gr.Group(elem_classes=["glass-card"]):
            ...
            <div style='margin-bottom:16px;'>
                <div class='sidebar-title'>\U0001f510 Data Rights & DSAR Management</div>
            ...
            with gr.Row():
                adm_export_btn = gr.Button("\U0001f4e5 Export My Data", elem_classes=["glass-btn"], size="sm")
                adm_delete_btn = gr.Button("\U0001f5d1\ufe0f Request Account Deletion", elem_classes=["danger-btn"], size="sm")
